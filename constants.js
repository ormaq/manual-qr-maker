...
window.els = {
    ...
    allBits: document.getElementById('allBitsInput'),
    modeBits: document.getElementById('modeBitsInput'),
    lengthBits: document.getElementById('lengthBitsInput'),
    payloadBits: document.getElementById('payloadBitsInput'),
